		...
		foreach ( $subscriptions as $subscription ) :
			...
			<tr>
				...
				<td>
					...
					?>
						&nbsp;|&nbsp;
						<a href="#" cancel-subscription="<?php echo $subscription->id; ?>"
						   class="give-cancel-subscription-reason"><?php echo apply_filters( 'give_recurring_cancel_subscription_text', __( 'Cancel Subscription', 'give-recurring' ) ); ?></a>
					<?php endif; ?>
